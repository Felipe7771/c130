...
# !W!idth  = int(cap.get(cv2.CAP_PROP_FRAME_  !H!eight  )) 
# !H!eight  = int(cap.get(cv2.CAP_PROP_FRAME_  !W!idth  ))

width  = int(cap.get(cv2.CAP_PROP_FRAME_WIDTH)) 
height  = int(cap.get(cv2.CAP_PROP_FRAME_HEIGHT)) 

#width  = int(cap.get(cv2.CAP_PROP_FRAME_WIDTH)) 
#height  = int(cap.get(cv2.CAP_PROP_FRAME_! W IDTH!))

#width  = int(cap.get(cv2.CAP_PROP_FRAME_! H EIGHT!)) 
#height  = int(cap.get(cv2.CAP_PROP_FRAME_HEIGHT))
...
def countFingers(image, hand_landmarks, handNo=0):
    ...
    if hand_landmarks:
        ...
        #finger_tip_x = (landmarks[8].x)* !W!idth
        #finger_tip_y = (landmarks[8].y)* !H!eight
